...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // ⚡ Bolt Optimization: Use .count(CountOption.exact) instead of .select()
      // to avoid downloading all matching records to the client and parsing them into Dart structures.
      // This saves bandwidth, memory, and CPU, converting an O(N) operation to O(1) in Dart.
      var query = _supabase
          .from('registros')
