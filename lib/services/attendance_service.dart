...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // ⚡ Bolt: Usar .count() en lugar de .select() evita descargar todos los registros
      // al cliente solo para contarlos, reduciendo drásticamente la latencia y el uso de memoria.
      var query = _supabase
          .from('registros')
