...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // Performance optimization: Using `.count(CountOption.exact)` directly returns the record
      // count from Supabase backend instead of downloading all rows using `.select()`
      var query = _supabase
          .from('registros')
