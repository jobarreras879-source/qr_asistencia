...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // ⚡ Bolt Optimization: Use .count(CountOption.exact) instead of downloading records.
      // This avoids transferring large lists to the client and parsing them just to get the length.
