...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // ⚡ Bolt: Usar .count(CountOption.exact) para evitar descargar todos los registros
      // Performance Impact: Reduce significativamente el tiempo de respuesta y
      // la memoria utilizada, especialmente cuando hay cientos de registros.
      var query = _supabase
          .from('registros')
