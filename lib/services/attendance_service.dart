...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // ⚡ Bolt Optimization: Use .count(CountOption.exact) to compute count in the DB.
      // Expected impact: Avoids downloading and parsing all rows on the client, saving network I/O and memory.
      var query = _supabase
          .from('registros')
