...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // BOLT OPTIMIZATION: Use .count(CountOption.exact) instead of .select() to avoid
      // downloading all matching records to the client just to get their count.
      // Expected impact: Faster execution and significantly lower memory footprint on large datasets.
      var query = _supabase
          .from('registros')
