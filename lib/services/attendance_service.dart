...
class AttendanceService {
  ...
  static Future<int> getTodayCount(String username) async {
    try {
      ...
      // ⚡ Bolt: Using `.count(CountOption.exact)` instead of `.select()`
      // reduces network overhead and memory usage by returning just the integer
      // count instead of downloading and parsing all matching rows into memory.
